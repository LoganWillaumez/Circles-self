...
const fr: Translation = {
	...
	serverError: {
	  ...
	  desc: {
		  ...
		  emailLink: 'Cliquez sur le lien dans l\'email que vous avez reçu pour commencer votre voyage !',
		  emailLinkNoValid: 'Le lien n\'est plus valide',
		  emailAskResend: 'Veuillez vous reconnecter à votre compte et renvoyer un email d\'activation.',
		  accountValidate: 'Votre compte a bien été validé !',
		  accountAskSignin: 'Vous pouvez maintenant vous connectez a votre compte afin de profiter de Circles.',
		},
		global: {
			switchLanguage: 'en',
			close: 'Fermer',
