...
const en: BaseTranslation = {
  ...
  errorInput: {
    ...
    firstnameMaxLength: 'Cannot exceed 20 characters',
    lastnameRequired: 'Required',
    lastnameMaxLength: 'Cannot exceed 20 characters',
    passwordMinLength: 'Must have at least 3 characters',
    passwordMaxLength: 'Cannot exceed 30 characters',
    genderRequired: 'Required',
    confirmPasswordMinLength: 'Must have at least 3 characters',
    confirmPasswordMaxLength: 'Cannot exceed 30 characters',
    emailRequired: 'Required',
    emailMaxLength: 'Cannot exceed 64 characters',
    invalidEmail: 'Not valid',
    birthdateRequired: 'Required',
    passwordsMustMatch: 'Must match',
    nameRequired: 'Required',
    nameMaxLength: 'Cannot exceed 10 characters',
    descriptionRequired: 'Required',
    descriptionMaxLength: 'Cannot exceed 50 characters',
    passwordLength: 'Must be between 3 and 30 characters',
    passwordNotMatch: 'Do not match',
    titleRequired: 'Required',
    startRequired: 'Required',
    endRequired: 'Required',
    invalidStart: 'Not valid',
    invalidEnd: 'Not valid',
    newPasswordMinLength: 'Must have at least 3 characters',
    newPasswordMaxLength: 'Cannot exceed 30 characters',
    randomCodeRequired: 'Required',
    confirmNewPasswordMinLength: 'Must have at least 3 characters',
    confirmNewPasswordMaxLength: 'Cannot exceed 30 characters',
  notKnow: 'Error',
}
};
