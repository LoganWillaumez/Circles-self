...
<script lang="ts">
  ...
  import type { CustomerDatas } from "@circles-self/circles/interfaces";
    ...
    import {faHouse, faGear, faRightFromBracket, faTableColumns} from '@fortawesome/free-solid-svg-icons';
...
<div transition:fade={{
        duration: 100
      }} class="fixed top-0 left-0 h-full z-50 flex items-center justify-center {isDesktop ? '' : 'bg-gray-900 bg-opacity-50'}">
