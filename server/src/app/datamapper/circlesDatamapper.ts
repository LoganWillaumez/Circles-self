...
import { CirclesDatas, CirclesInputDatas } from '../../ts/interfaces/circle.interfaces';
...
const circlesDataMapper = (client: Pool) => {
  ...
  async createCircle(id: number, datas: CirclesInputDatas): Promise<CirclesDatas | false> {
  ...
  return false;
    ...
    async updateCircle(id: number, datas: Partial<CirclesInputDatas>): Promise<CirclesDatas | false> {
